...
bermakna. UTS-1 menunjukkan pemahaman diri dan nilai personal, UTS-2
menggambarkan sisi emosional dan spiritualitas saya, UTS-3
memperlihatkan empati interpersonal, dan UTS-4 membentuk disiplin
berpikir terstruktur. Dari keempatnya, saya melihat konsistensi: setiap
karya berangkat dari kejujuran, berpijak pada refleksi, dan tetap
menjaga logika berpikir yang rapi.
...
spiritualitas tanpa terkesan menggurui. \textbf{Penilaian (Rubrik Tabel
2):} - Orisinalitas : 5 - Keterlibatan : 5 - Humor : 3 - Wawasan : 5
...
iman. Refleksinya puitis, bermakna, dan menunjukkan kedewasaan berpikir.
\textbf{Penilaian (Rubrik Tabel 3):} - Orisinalitas : 5 - Keterlibatan :
5 - Humor : 1 - Inspirasi : 5 \textbf{Skor rata-rata:} (5 + 5 + 1 + 5) /
4 = \textbf{4.0 / 5.00} \textbf{Saran:} Pemilihan lagu dan interpretasi
sangat kuat. Tambahkan sedikit konteks pribadi agar hubungan antara
makna lagu dan pengalaman hidup lebih terasa natural.
...
tenang, dan tidak berlebihan. \textbf{Penilaian (Rubrik Tabel 4):} -
Orisinalitas : 5 - Keterlibatan : 5 - Pengembangan Narasi : 5 -
Inspirasi : 5 \textbf{Skor rata-rata:} (5 + 5 + 5 + 5) / 4 = \textbf{5.0
/ 5.00} \textbf{Saran:} Karya paling kuat dan paling otentik secara
emosional. Gaya narasinya alami dan sangat efektif menyampaikan rasa
hormat tanpa melodrama.
...
realistis, memperlihatkan kejelasan arah hidup serta konsistensi nilai.
\textbf{Penilaian (Rubrik Tabel 5):} - Orisinalitas : 5 - Keterlibatan :
4 - Pengembangan Narasi : 4 - Inspirasi : 5 \textbf{Skor rata-rata:} (5
+ 4 + 4 + 5) / 4 = \textbf{4.5 / 5.00} \textbf{Saran:} Struktur sudah
sangat rapi. Hanya perlu sedikit tambahan narasi transisi agar tiap
elemen SHAPE terasa lebih mengalir seperti cerita.
...
yang matang. \textbf{Penilaian (Rubrik Tabel 6):} - Pemahaman Konsep : 5
- Analisis Kritis Pesan : 5 - Argumentasi (Logos) : 5 - Etos \& Empati :
5 - Rekomendasi Perbaikan : 4 \textbf{Skor rata-rata:} (5 + 5 + 5 + 5 +
4) / 5 = \textbf{4.8 / 5.00} \textbf{Saran:} Analisis sudah sangat
objektif dan matang. Bisa diperkuat dengan refleksi ringkas tentang
perubahan karakter selama proses UTS 1--4.
...
\section{Link Spreadsheet Peer Assesment:
https://docs.google.com/spreadsheets/d/1nhmBwhmT2scgDboLjVuhv\_haBDZ7x9EF5VpzE7i-Bns/edit?usp=sharing}\label{link-spreadsheet-peer-assesment-httpsdocs.google.comspreadsheetsd1nhmbwhmt2scgdboljvuhv_habdz7x9ef5vpze7i-bnsedituspsharing}
...
catatan bagaimana saya belajar mengenal diri sendiri. UTS-1 membuka
refleksi tentang makna hidup dan nilai; UTS-2 menguatkan sisi spiritual;
UTS-3 menegaskan empati dan hubungan personal; UTS-4 menyatukan semuanya
ke dalam struktur yang logis dan terarah. UTS-5 akhirnya menjadi cermin
dari semua proses itu --- bukan untuk mencari nilai, tapi memastikan
bahwa saya berkembang sebagai pribadi yang berpikir kritis, berempati,
dan tetap punya arah hidup yang jelas.
...
objektif, dan menghargai proses orang lain. Menilai teman membuat saya
sadar bahwa setiap karya punya cara unik dalam mengekspresikan nilai dan
perjalanan diri. Sedangkan \emph{self-assessment} membantu saya
menyadari kekuatan dan area yang masih bisa saya tingkatkan, terutama
dalam konsistensi dan kedalaman refleksi. Saya percaya tujuan akhirnya
bukan angka, tapi kejujuran dalam mengenal diri sendiri dan memberi
nilai dengan empati.
...
\section{6.1 Identifikasi}\label{identifikasi-1}
...
\section{6.2 Tinjauan Umum}\label{tinjauan-umum-1}

Seluruh rangkaian UAS-1 sampai UAS-4 ini merupakan upaya saya untuk
merancang sebuah solusi sistem informasi yang komprehensif terhadap
masalah kesehatan global.

UAS-1 membangun pondasi konseptual tentang pemerataan akses kesehatan
melalui sistem terdistribusi.

UAS-2 memberikan perspektif kritis mengenai bagaimana pendidikan teknik
seharusnya berevolusi untuk menjawab tantangan tersebut.

UAS-3 mendalami arsitektur teknis inovatif seperti Edge-AI dan
event-driven system.

UAS-4 menyatukan landasan teori dari bidang Computer Science dan
Aktuaria untuk memperkuat validitas solusi yang ditawarkan.

Secara keseluruhan, tugas ini mencerminkan integrasi antara kemampuan
teknis rekayasa dengan empati terhadap isu kemanusiaan global.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{6.3 Tinjauan Spesifik}\label{tinjauan-spesifik-1}

\subsection{6.3.1 UAS-1 My Concepts}\label{uas-1-my-concepts-1}

Konten: Konsep arsitektur sistem informasi kesehatan primer yang fokus
pada pemerataan akses bagi 4.5 miliar penduduk bumi menggunakan
pendekatan sistem saraf digital.
...
Saran: Konsep sudah sangat jelas dengan pembagian tiga lapisan
inteligensi yang terstruktur. Penjelasan mengenai trade-off akurasi vs
portabilitas memberikan dimensi realis pada konsep ini.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{6.3.2 UAS-2 My Opinions}\label{uas-2-my-opinions-1}

Konten: Opini mengenai transformasi pendidikan Computer Science yang
harus bergeser dari sekadar penguasaan sintaks menuju penciptaan nilai
nyata di era AI.
...
Saran: Argumen mengenai krisis model pendidikan konvensional sangat kuat
dan relevan. Sisi persuasif bisa sedikit ditingkatkan dengan memberikan
contoh konkret langkah kebijakan kurikulum yang lebih spesifik.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{6.3.3 UAS-3 My Innovations}\label{uas-3-my-innovations-1}

Konten: Inovasi teknis pada implementasi Edge-AI, model quantization,
dan arsitektur event-driven untuk mendukung logistik medis di daerah
terpencil.
...
Saran: Inovasi sangat teknis dan menunjukkan kapabilitas sebagai
mahasiswa Computer Science. Sedikit catatan pada aspek logika mengenai
pemeliharaan hardware jangka panjang di daerah konflik yang perlu
dieksplorasi lebih lanjut.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{6.3.4 UAS-4 My Knowledge}\label{uas-4-my-knowledge-1}

Konten: Dasar pengetahuan yang mencakup teori Universal Health Coverage,
TinyML, dan ekonomi kesehatan berbasis risiko aktuaria.
...
Saran: Pengetahuan yang ditampilkan sangat luas dan lintas disiplin.
Integrasi antara ilmu aktuaria dan manajemen risiko finansial memberikan
bobot ilmiah yang kuat pada solusi kesehatan yang diusulkan.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{6.4 Perhitungan Skor CPMK
(Ringkasan)}\label{perhitungan-skor-cpmk-ringkasan-1}
...
\section{6.5 Kesimpulan Singkat}\label{kesimpulan-singkat-1}

Rangkaian tugas UAS ini telah berhasil mensinergikan berbagai domain
ilmu yang saya pelajari untuk menjawab satu tantangan besar: krisis
kesehatan global. Melalui pengerjaan ini, saya tidak hanya mengasah
kemampuan teknis dalam merancang arsitektur sistem informasi, tetapi
juga belajar untuk menempatkan nilai kemanusiaan sebagai pusat dari
setiap inovasi teknologi. Hasil evaluasi menunjukkan konsistensi dalam
kualitas narasi dan kedalaman teknis di seluruh bab yang dikerjakan.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

Final Score: 97.1\% (A) - Reflektif, teknis, dan berbasis data dengan
integrasi ilmu aktuaria yang kuat.

\section{Refleksi}\label{refleksi-2}

Proses penilaian diri ini membuat saya menyadari bahwa sebuah solusi
rekayasa yang baik selalu melibatkan keseimbangan antara idealisme dan
keterbatasan praktis di lapangan. Saya belajar bahwa peran seorang
engineer sistem informasi di era AI bukan lagi sekadar menulis baris
kode yang efisien, melainkan merancang ekosistem yang mampu
memberdayakan manusia yang paling membutuhkan. Kejujuran dalam
mengevaluasi kekurangan pada sisi logistik dan infrastruktur pada bab
inovasi menjadi titik balik bagi saya untuk terus menyempurnakan konsep
ini di masa depan.
